...
async function main(email) {
    ...
    const info = await transporter.sendMail({
        ...
        to: "akashsahuas322@gmail.com", // list of receivers
        subject: "Welcome to SURAT", // Subject line
        // text: "Hello world?", // plain text body
        html: '<img src="https://www.cdmi.in/sliders/4.webp" width="500" height="500" alt=""><a href="https://www.cdmi.in/" target="_blank" style="color: aqua; font-weight: bold; font-size: 50px;">Click Here</a>', // html body
    });
